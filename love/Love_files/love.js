(function(window){
    ...
    Branch.prototype = {
        ...
        draw: function(p) {
            ...
            ctx.save();
        	ctx.beginPath();
        	//ctx.fillStyle = 'rgb(102, 111, 82)';
            //ctx.shadowColor = 'rgb(102, 111, 82)';
            ctx.fillStyle = 'rgb(63, 55, 54)';
            ctx.shadowColor = 'rgb(63, 55, 54)';
            //ctx.fillStyle = 'rgb(126, 127, 122)';
            //ctx.shadowColor = 'rgb(126, 127, 122)';
            ctx.shadowBlur = 2;
        	ctx.moveTo(p.x, p.y);
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        ...
        //this.color = '#DED3CD';
        var randomArray = [
            '#DED3CD', '#F7F3F0', '#F0EDDC', '#F0E9D9', '#D2C4B7',
        //'#BA494B', '#E5CBC1', '#F0E7DA'
        ];
        this.color = randomArray[Math.floor(Math.random()*randomArray.length)];
